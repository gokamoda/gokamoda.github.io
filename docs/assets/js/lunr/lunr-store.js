var store = [{
        ...
        "excerpt":"We are pleased to announce that our paper has been accepted to COLING 2025.                               , .,           , .,           , .,      &amp;           , .  (2025).  Quantifying the Influence of Evaluation Aspects on Long-Form Response Assessment.  In Proceedings of the 31st International Conference on Computational Linguistics (COLING 2025).                                                ACL Anthology     &nbsp;                                    Google Scholar     &nbsp;                                    GitHub                 -&gt; Publications  ","categories": ["News"],
        "tags": [],
        "url": "/news/coling2025-accept/",
        "teaser": null
      },{
        "title": "✅ Paper accepted to the ICLR 2025",
        "excerpt":"We are pleased to announce that our paper has been accepted to ICLR 2025.                               , .,           , .,           , .,           , .,           , .,           , .,      &amp;           , .  (2025).  SoftMatcha: A Soft and Fast Pattern Matcher for Billion-Scale Corpus Searches.  In The Thirteenth International Conference on Learning Representations (ICLR 2025).                                                OpenReview     &nbsp;                                    arXiv     &nbsp;                                    Google Scholar     &nbsp;                                    Project Page                 -&gt; Publications  ","categories": ["News"],
        "tags": [],
        ...
        "excerpt":"We are pleased to announce that our paper has been accepted to the Findings of EMNLP 2025.                               , .,           , .,           , .,           , .,           , .,           , .,           , .,      &amp;           , .  (2025).  How a Bilingual LM Becomes Bilingual: Tracing Internal Representations with Sparse Autoencoders.  In Findings of the Association for Computational Linguistics: EMNLP 2025.                                                ACL Anthology     &nbsp;                                    Google Scholar     &nbsp;                                    arXiv                 -&gt; Publications  ","categories": ["News"],
        "tags": [],
        "url": "/news/emnlp2025findings-accept/",
        "teaser": null
      },{
        "title": "✅ Paper accepted to the 8th BlackboxNLP Workshop",
        "excerpt":"We are pleased to announce that our paper has been accepted to the 8th BlackboxNLP Workshop.                               , .,           , .,           , .,           , .,      &amp;           , .  (2025).  Understanding the Side Effects of Rank-One Knowledge Editing.  In BlackboxNLP 2025: The 8th Workshop on Analyzing and Interpreting Neural Networks for NLP.                                                ACL Anthology     &nbsp;                                    Google Scholar     &nbsp;                                    arXiv                 -&gt; Publications  ","categories": ["News"],
        "tags": [],
        ...
        "excerpt":"We are pleased to announce that our paper has been accepted to the 8th BlackboxNLP Workshop.                               , .,           , .,           , .,           , .,           , .,           , .,      &amp;           , .  (2025).  Can Language Models Handle a Non-Gregorian Calendar? The Case of the Japanese wareki.  In Proceedings of the 14th International Joint Conference on Natural Language Processing and the 4th Conference of the Asia-Pacific Chapter of the Association for Computational Linguistics (IJCNLP-AACL 2025).                                                ACL Anthology     &nbsp;                                    Google Scholar     &nbsp;                                    arXiv                 -&gt; Publications  ","categories": ["News"],
        "tags": [],
        "url": "/news/ijcnlpaacl2025-accept/",
        "teaser": null
      },{
        "title": "🎤 Presentation at NLP 2026",
        "excerpt":"   NLP 2026 にて以下の発表があります。                            米田優峻,                鴨田豪,           松下祐介,           末永幸平,           秋葉拓哉,           和賀正樹,           横井祥  (2026).  SoftMatcha 2: 一兆語規模のコーパスに対する柔らかく超高速な検索システム.  言語処理学会 第32回年次大会.                                     Project Page     &nbsp;                  NLP 2026 プログラム                                    木谷頼斗,           大橋諭貴,           佐藤宏亮,                鴨田豪,           高橋良允,           山本悠士,           塩野大輝,           坂口慶祐,           小林悟郎  (2026).  Attention Sink および Massive Activation の発生機序の分解.  言語処理学会 第32回年次大会.                                     NLP 2026 プログラム                                    大橋諭貴,           木谷頼斗,           佐藤宏亮,           高橋良允,                鴨田豪,           山本悠士,           塩野大輝,           坂口慶祐,           小林悟郎  (2026).  注意機構における Attention Sink のバイアス項的解釈.  言語処理学会 第32回年次大会.                                     NLP 2026 プログラム                 -&gt; Publications   ※ ちなみに、発表部分だけを抜き出してスクショを撮るためのスクリプトメモは こちらのノート にあります。  ","categories": ["News"],
        "tags": [],
